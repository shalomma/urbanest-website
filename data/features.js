...
export const features6 = [
  {
    ...
    imgSrc: "/assets/images/template/feature-01.svg",
    imgAlt: "Share tools quickly and confidently in minutes",
    title: "חיזוק והוספה - תמ\"א 38/1",
    description:
      "תהליך המאפשר את חיזוק הבניין מפני רעידות אדמה והוספת שטח לדירות, ממ\"ד ומעלית. פרויקט של חיזוק והוספה הוא לרוב פרויקט המתאפשר כאשר אין מספיק שטח להרוס את הבניין ולבנותו מחדש ולכן הוא נחשב פרויקט בהיקף קטן יותר, ולרוב עם זמני בנייה קצרים יותר.",
    link: null,
  },
  {
    id: 2,
    imgSrc: "/assets/images/template/feature-02.svg",
    imgAlt: "Connect every part of your entire business",
    title: "הריסה ובנייה מחדש - תמ\"א 38/2",
    description:
      "תהליך המאפשר הריסת המבנה הקייםובנייתנו מחדש. תמ\"א 38/2 מתייחס לסעיפים מסוימים בחוק תכנון ובניה, שבהם ניתן להעניק יתרונות כגון ריבוי קומות בבתים, שיפוץ דירות קיימות, תוספת מעליות, ושיפוצים שונים, כדי לשפר את איכות המגורים ולקדם עיצוב העיר. התוכנית מקנה יתרונות כלכליים ופיננסיים לבעלי הנכסים המעורבים על מנת לעודד שדרוגים ושיפוצים בנכסים הקיימים.",
    link: null,
  },
  {
    id: 3,
    ...
    title: "פינוי בינוי",
    description:
      "פרויקט פינוי בינוי הוא תהליך בו מתכננים לפרק בניינים או מבנים קיימים ולבנות במקום שימושים חדשים או בניינים חדשים. זהו תהליך רב-שלבי הכולל את פינוי המבנה הקיים, ניתוח תכנון מחדש של האזור והמרחב, ובניית מבנים חדשים או שימוש חדש בשטחים אלו. המטרה של פרויקט פינוי בינוי עשויה להיות רחבה: לשדרג אזורים בעיר, ליצור שטחים ציבוריים, לפתח תשתית חדשה או ליצור שימושים מסחריים או מגורים חדשים. ניתן לראות כאן הזדמנות לשדרג או לשנות את מבנה העיר, להשפיע על סביבתה וליצור שיפורים עיקריים בחיי התושבים ובתרבות העיר.",
    link: null,
  }
];
