...
export default function Nav2() {
  ...
  return (
      <>
          ...
          {/*</li>*/}
          <li>
              <Link href={`/page-about`}>קצת עלינו</Link>
          </li>
          <li>
              <Link href={`/page-features`}>למה אנחנו כאן</Link>
          </li>
          <li>
              <Link href={`/page-features`}>התחדשות עירונית</Link>
          </li>
          <li>
              <Link href={`/page-features`}>התהליך</Link>
          </li>
          <li>
