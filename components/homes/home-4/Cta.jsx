      ...
      <div className="section-outer panel pb-4 sm:pb-6 xl:pb-9">
        <div className="container max-w-xl">
          ...
          >
            ...
            >
              <h2 className="h3 lg:h2 m-0">אנחנו פה בשבילכם</h2>
              <p className="fs-6 md:fs-5 xl:fs-4 text-dark dark:text-white text-opacity-70">
                אנחנו כאן כדי להעניק לדיירים את הביטחון להתחיל פרויקט, תוך שקיפות מלאה בהליך וללוות אתכם יד ביד מהרגע הראשון ועד קבלת המפתח לדירה החדשה.
              </p>
