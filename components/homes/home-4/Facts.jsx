          ...
          <div className="section-inner panel">
            ...
            >
              <h2 className="h4 md:h3 m-0">
                אנחנו אורבנסט, הקהילה הישראלית להתחדשות העירונית
              </h2>
              <p className="fs-6 xl:fs-5 text-dark dark:text-white text-opacity-70">
                אורבנסט משנה את עולם ההתחדשות העירונית על ידי העברת מוקדי הידע וקבלת ההחלטות לבעלי הדירות.
                עם אורבנסט, הדרך למימוש הפוטנציאל של הבית שלך, בטוחה ומהירה מתמיד.
                עם ניסיון ומומחיות של שנים רבות בתחום וטכנולוגיה מתקדמת, אנחנו מספקים מעטפת מקצה לקצה לדייר.
              </p>
            </div>
            <div
