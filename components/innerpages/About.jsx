          ...
          >
            <div className="vstack items-center gap-4 mb-4 sm:mb-6 lg:mb-8 max-w-850px mx-auto text-center">
              ...
              <p className="fs-6 md:fs-5 text-dark dark:text-white text-opacity-70">
                אנחנו בקונטור, מבינים שאתם מפקידים את הנכס הכי משמעותי שלכם - הדירה שלכם, ולכן אתם צריכים להיות שותפים מלאים לכל התהליך. אתם גם צריכים לקבל את כל הערבויות והביטחונות שמגיעים לכם כדי להבטיח שבסוף התהליך, תקבלו את כל מה שמגיע לכם. אנחנו כאן כדי להעניק לדיירים את הביטחון להתחיל פרויקט כזה, תוך שקיפות מלאה בהליך הפרויקט וללכת איתם יד ביד מהרגע הראשון ועד קבלת המפתח בדירה החדשה.
              </p>
            </div>
