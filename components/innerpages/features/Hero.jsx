          ...
          <div className="section-inner panel mt-2 sm:mt-4 lg:mt-0">
            ...
            >
              ...
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                התחדשות עירונית היא תהליך בו ערים או אזורים עוברים שינויים באופן שמשפר את איכות החיים והתשתית העירונית שלהם.
                היא כוללת שדרוגים בתחבורה, תכנון עירוני חכם, שימור סביבה, בנייה חדשה ושיפוץ, פיתוח חברתי ותרבותי, ייעוץ וניהול עירוני, ושיפור בשירותים ציבוריים. המטרה היא ליצור ערים יעילות ונעימות למגורים, המספקות לתושביהן תשתית
                מתקדמת יותר ואיכות חיים טובה יותר.
              </p>
            </div>
