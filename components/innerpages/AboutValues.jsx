        ...
        <div className="container max-w-lg">
          <div className="section-inner panel">
            <div className="panel vstack gap-4 sm:gap-6 xl:gap-8">
              ...
              <h5
                  className="h5 sm:h4 lg:h3 m-0 text-center"
                  data-anime="onview: -100; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: 150;"
                >
                אנחנו כאן כדי לרתום את הניסיון שלנו בעולם ההתחדשות העירונית לטובתכם.
                מבטיחים לספק לכם את כל הכלים והידע ליזום בעצמכם פרויקט התחדשות עירונית בבניין שלכם
              </h5>
              <div
